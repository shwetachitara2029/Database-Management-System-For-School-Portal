...
class Student_Portal():
    ...
    #====================creating logo==================
        self.photo= PhotoImage(file='Icon3.png')
        self.label= Label(image=self.photo)
        self.label.grid(row=0,column=0)
        self.label1= Label(font=('arial', 15, 'bold'),text= 'School Portal System', fg= 'dark blue',bg= 'gray')
    ...
    #=====================Database table display box======================
        ...
        self.tree.grid(row=8, column= 0, columnspan= 1)
        ...
        self.tree.column('#6', width=60, stretch= False)
    #==================Time and Date============================
        def tick():
        ...
        self.lblInfo.grid(row= 10, column= 0, columnspan= 1)
        tick()
    #======================Menu Bar==========================
        Chooser = Menu()
        itemone = Menu()
        ...
        itemone.add_command(label='Exit Record',command= self.edit)
...
if __name__ == '__main__':
    ...
    apllication= Student_Portal(root )
    root.mainloop()